# Скрипт предназначен для выявления аномалий в наборе программного обеспечения, установленного на одном хосте
# В результате будет создан файл с отчётом

# Задаём начальные настройки и создаём/обнуляем файл с отчётом
$Machine = "host.domain.ru"
$LogServerName = "LogServerName"
$LogFile = "\\$LogServerName\Logs\search_soft\$Machine.txt"
...
"`nStart search soft on host $Machine"
